...
<head>
    ...
    <title>Intervue - @yield('title')</title>
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    @auth
                        @if(auth()->user()->isReviewer())
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('interviews.index') }}">My Interviews</a>
                            </li>
                            <li class="nav-item">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                {{ Auth::user()->name }} <span class="badge bg-info">{{ Auth::user()->role }}</span>
                            </a>
